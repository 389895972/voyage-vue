<template>
    <el-container>
        <div class="home-container">
            ...
            <div class="main">
                <div class="first">
                    <div   class="col-md-5 col-xs-11 aikit_img_div" style="background-color: white;padding: 0;">
                        ...
                        <div class="product_show">
                            ...
                            <div>
                                ...
                                <ul >
                                    ...
                                    <li>
                                        Sensor support including the industry=E2=80=99s best performing ICM-426886-Axis High Performance Motion Sensor, ICS-41351 Top Port Digital Microphone, and ICP-10101 Barometric Pressure Sensor from TDK InvenSense
                                    </li>
                                    <li>
                        ...
                        <div class="product_show" id="i4">
                            ...
                            <div class="pro_border">
                                <table border="1" style="border-collapse:collapse;width:100%;text-align:center;line-height:2em;">
                                    ...
                                    </td><td>CPU</td><td>Qualcomm SDA845 processor, 8x Qualcomm=C2=AE Kryo<sup>TM</sup> 385 @ 2.8GHz</td>
                                    </tr>
                                    <tr><td>GPU</td><td>Adreno 630 GPU</td></tr><tr><td>DSP</td><td>Hexgan 685 DSP</td>
                                    </tr>
                                    <tr><td>ISP</td><td>Qualcomm Spectra<sup>TM</sup> 280 image sensor processor</td></tr>
